...
class TSCTrainerRLAdversarial(BaseTrainer):
    ...
    def train(self):
        ...
        for e in range(self.episodes):
            ...
            print('real_travel_time > max_travel_time',real_travel_time, max_travel_time)
            ...
            elif real_travel_time <= max_travel_time:
                max_travel_time = real_travel_time
                [ag.save_model(model_path) for ag in self.attacker_agents]
            elif e == 0:
                # guarantee a checkpoint exists even if nothing ever improves
                [ag.save_model(model_path) for ag in self.attacker_agents]
