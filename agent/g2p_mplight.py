...
@Registry.register_model('g2p_mplight')
class G2PMPLight(RLAgent):
    '''
    ...
    def __init__(self, world, rank):
        ...
        for inter in self.world.intersections:
            ...
            tmp_generator = RouteAwareStateGenerator(self.world, node_obj, ["lane_waiting_count", "lane_vehicles"], in_only=True, average=None)
...
class FRAP(nn.Module):
    ...
    def __init__(self, dic_agent_conf, output_shape, phase_pairs, competition_mask):
        ...
        self.d3 = nn.Linear(self.demand_shape, self.d_out)

        self.lane_embedding = nn.Linear(self.p_out + self.d_out * 3, self.lane_embed_units)
    ...
    def forward(self, states):
        ...
        for i in range(num_movements):
            ...
            demand3 = states3[:, i:i + self.demand_shape]
            demand3 = torch.sigmoid(self.d3(demand3))

            phase_demand = torch.cat((phase, demand1, demand2, demand3), -1)
