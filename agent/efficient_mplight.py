...
import gym
from generator import LaneVehicleGenerator, IntersectionPhaseGenerator, EfficientStateGenerator
...
@Registry.register_model('efficient_mplight')
class EfficientMPLight(RLAgent):
    '''
    ...
    def __init__(self, world, rank):
        ...
        for inter in self.world.intersections:
            ...
            tmp_generator = EfficientStateGenerator(self.world, node_obj, ['lane_waiting_count'], in_only=True, average=None)
