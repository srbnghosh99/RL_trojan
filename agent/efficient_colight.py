...
from generator import EfficientStateGenerator
...
@Registry.register_model('efficient_colight')
class EfficientCoLightAgent(RLAgent):
    ...
    def __init__(self, world, rank):
        ...
        for inter in self.world.intersections:
            ...
            tmp_generator = EfficientStateGenerator(self.world, inter, ['lane_waiting_count'], in_only=True,
                                                    average=None)
