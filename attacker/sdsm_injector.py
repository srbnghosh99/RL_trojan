...
class SDSMInjector:
    ...
    def __init__(self, world, intersection_id, max_vehicles_per_segment=8,
                 num_segments=3, penalty_lambda=0.50):
        """
    ...
    def calculate_reward(
        ...
        normalized_cost = (
                total_fake_vehicles
                / max(max_total_fakes, 1)
        )

        positive_impact = max(delta_delay, 0.0)
        ...
        reward = (
                delta_delay
                - self.penalty_lambda * normalized_cost
