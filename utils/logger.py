...
def get_output_file_path(config):
    ...
    #     param['network'], f"{param['world']}_{param['agent']}_{param['seed']}", param['prefix'])
    # path = os.path.join(config['world']['dir'], 'output_data', param['task'],
    #                     param['network'], param['agent'], f"{param['world']}_{param['seed']}")
    path = os.path.join(config['world']['dir'], 'output_data', param['task'],
                        param['agent'], param['network'], f"{param['world']}_{param['seed']}")
    return path
