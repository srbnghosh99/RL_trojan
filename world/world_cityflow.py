...
class World(object):
    ...
    def reset_fake_vehicles(self):
        """
        Reset all fake vehicles from all intersections.
        In CityFlow, fake vehicles are tracked in inter.fake_vehicles dict
        (not added to actual simulation), so we just clear the tracking.
        """
